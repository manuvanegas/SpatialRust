...
julia --machine-file $SLURM_NODEFILE --sysimage src/PkgCompile/ABCSysimage.so ~/SpatialRust/scripts/ABC/sims/runABC.jl parameters_1000000 $SLURM_ARRAY_TASK_ID $SLURM_NTASKS 400 #500
