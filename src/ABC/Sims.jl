...
function simulate_plots(p_row::DataFrameRow,
    ...
    model1 = init_spatialrust(
        ...
        max_inf = p_row[:max_inf],
        host_spo_inh = p_row[:host_spo_inh],
        opt_g_temp = p_row[:opt_g_temp],
        max_g_temp = p_row[:max_g_temp],
        spore_pct = p_row[:spore_pct],
        rust_paras = p_row[:rust_paras],
        exh_threshold = p_row[:exh_threshold],
        rain_distance = p_row[:rain_distance],
        tree_block = p_row[:tree_block],
        wind_distance = p_row[:wind_distance],
        shade_block = p_row[:shade_block],
        lesion_survive = p_row[:lesion_survive],
        )
